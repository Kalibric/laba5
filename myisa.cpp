...
public:
    ...
    virtual bool isA(const std::string& iClassName)
    {
        return (iClassName == (string)"Building");
    }
...
public:
    ...
    bool isA(const std::string& iClassName) override
    {
        return iClassName == "Building" || iClassName == "ResidentialBuilding";
    }
...
public:
    ...
    bool isA(const std::string& iClassName) override
    {
        return iClassName == "Building" || iClassName == "ResidentialBuilding" || iClassName == "House";
    }
...
public:
    ...
    bool isA(const std::string& iClassName) override
    {
        return iClassName == "Building" || iClassName == "ResidentialBuilding" || iClassName == "Flat";
    }
